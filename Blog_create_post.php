...
if(isset($_POST["Submit"])){
  ...
  /*}elseif (strlen($PostTextMB)<140) {
    $_SESSION["ErrorMessage"]= "Post Description should be less than 140 characters";
    Redirect_to("Blog_create_post.php");*/
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <header class="bg-dark text-white py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
          <h1><i class="fas fa-edit" style="color:#eae7dc;"></i> Add New Post</h1>
          </div>
        </div>
      </div>
    </header>
        ...
        <div class="card bg-secondary text-light mb-3">
          <div class="card-body bg-dark">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="Post" name="PostDescription" rows="8" cols="80" placeholder="Type post text here in 1000 characters"></textarea>
            </div>
            <div class="row">
